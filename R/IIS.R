...
IIS<-function(microApath, metaApath, conf = NULL, groupInfo = NULL, nDFS = 0.4,
  ...
  IIS_res=list("Correlation analysis results"=mic_meta_cor_filtered,'mic_meta_cor'=mic_meta_cor,'mic_meta_cor_p.adjust'=mic_meta_cor_p.adjust,"Dgree_Score"=DS,"Abundance_Score"=AS,"Edge_Score"=ES,"Diff_Score"=DFS,"IIS"=NScore,'IIS_completed'=Node_Score)
